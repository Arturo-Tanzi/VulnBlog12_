      ...
      <div class="col-md-10 col-lg-8">
        <div class="card shadow-lg border-0 rounded-4 overflow-hidden mb-4 position-relative">
          ...
          <div class="card-body bg-white p-4">
            ...
            // Condizione sicura per verificare che se l'utente è un admin e l'utente loggato sia l'utente che ha creato l'articolo; mostri i pulsanti di modifica e cancellazione
